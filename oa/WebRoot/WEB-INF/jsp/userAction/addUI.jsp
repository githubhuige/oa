...
<div id=MainArea>
    ...
    <s:form action="userAction_%{id==null ? 'add':'update'}">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td>  
                         <%-- headerKey="" headerValue="请选择部门" 表示默认选中 --%>
                            <s:select name="departmentId" cssClass="SelectStyle"
                            	list="#listDepartment" listKey="id" listValue="name"
                    ...
                    <tr>
                        ...
                        <td>
                        	<s:select name="roleIds" cssClass="SelectStyle"
                        		...
                        		list="#listRole" listKey="id" listValue="name">
                            </s:select>
							按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
