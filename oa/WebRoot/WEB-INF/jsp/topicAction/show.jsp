	...
	<%-- 	
		<script type="text/javascript">
			function gotoPage( pageNum ){
				...
				<%-- topicAction_show.action?id=${id}表示本主题页面
					&pageNum=" + pageNum：表示在此主题转到第几页
					...
					<td class="no_color_bg"><div class="InputContent">
						...
						<s:iterator begin="1" end="14" var="num">
								<td width="50" style="border-bottom:0 solid #ffffff">
									...
									<label for="r_${num}"><img width="19" height="19" src="${pageContext.request.contextPath}/style/images/face/face${num }.gif" disabled="true" align="absmiddle"/></label>
								</td>
								</s:iterator>
								</tr>
